...
- (IBAction) onReset:(UIButton *)button {
    ...
    NSArray* urls = @[@"http://10.8.160.109:8880/Postman-osx-4.2.2.zip",
                      @"http://10.8.74.84:8880/AnyDemo.ipa",
                      @"http://123.103.23.204:8000/staticresource/static/downloadtest/lllllllllllllllloooooooooooooonnnnnnnnnggggggggg.rmvb",
                      ...
                      @"http://123.103.23.204:8000/staticresource/static/downloadtest/test.html",
