...
//      NSLog(@"Enable or disable the gesture recognizers:%d,%d", self.cellScrollView.isDragging, self.cellScrollView.isDecelerating);
        if (!self.cellScrollView.isDragging && !self.cellScrollView.isDecelerating)
        {
//          NSLog(@"Enable or disable the gesture recognizers (%d) enable......", self.tag);
            self.tapGestureRecognizer.enabled = YES;
            self.longPressGestureRecognizer.enabled = (_cellState == kCellStateCenter);
        }
        else
        {
//          NSLog(@"Enable or disable the gesture recognizers (%d) disable......", self.tag);
