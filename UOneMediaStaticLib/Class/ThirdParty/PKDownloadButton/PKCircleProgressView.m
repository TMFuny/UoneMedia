...
- (void)setProgressTrackColor:(UIColor *)progressTrackColor {
    ...
    self.filledLineCircleView.strokeColor = progressTrackColor;
    [self setNeedsDisplay];
}

- (void)setProgressColor:(UIColor *)progressColor {
    _progressColor = progressColor;
    self.emptyLineCircleView.strokeColor = progressColor;
    [self setNeedsDisplay];
}

- (UIColor *)progressColorForDrawing {
    return (_progressColor != nil ? _progressColor : self.tintColor);
}

- (UIColor *)progressTrackColorForDrawing {
    return (_progressTrackColor != nil ? _progressTrackColor : self.tintColor);
}
#pragma mark - UIView
...
- (PKCircleView *)createFilledLineCircleView {
    ...
    filledCircelView.strokeColor = [self progressTrackColor];
